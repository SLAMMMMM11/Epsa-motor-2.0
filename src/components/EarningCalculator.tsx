...
export default function EarningCalculator() {
  ...
  // Cuota referencial ~ S/ 16,199 con ~25% inicial a 24 meses (ilustrativo)
  const estimatedCreditInstallment = 520;
  const remainingProfitAfterCredit = netMonthlyProfit - estimatedCreditInstallment;

  return (
    <section className="py-20 bg-[#060a13]/60 border-b border-[#1e2e4a] relative overflow-hidden" id="calculator-section">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          {/* Controls Panel - LEFT */}
          <div className="lg:col-span-5 bg-[#131c2e] border border-[#1e2e4a] rounded-xl p-6 md:p-8 flex flex-col justify-between space-y-8">
            <div className="space-y-6">
              <div className="flex items-center gap-2 pb-4 border-b border-[#1e2e4a]/60">
                <Sparkles className="w-4 h-4 text-[#60a5fa]" />
                <h3 className="text-sm font-bold uppercase tracking-wider text-[#f1f5f9]">Parámetros de Trabajo</h3>
              </div>

              {/* Slider 1: Daily Rides */}
              <div className="space-y-3">
                <div className="flex justify-between items-center text-xs">
                  <span className="text-[#a1a1aa] font-bold uppercase tracking-wide">Carreras Diarias Realizadas</span>
                  <span className="text-[#f1f5f9] font-mono bg-[#1a263e] px-2.5 py-1 rounded-xl border border-[#1e2e4a] font-bold">
                ...
                <input
                  ...
                  className="w-full h-1 bg-[#1a263e] rounded-lg appearance-none cursor-pointer accent-[#60a5fa]"
                />
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center text-xs">
                  <span className="text-[#a1a1aa] font-bold uppercase tracking-wide">Precio Promedio por Carrera</span>
                  <span className="text-[#60a5fa] font-mono bg-[#1a263e] px-2.5 py-1 rounded-xl border border-[#1e2e4a] font-bold">
              ...
              {/* Fuel Type Selector */}
              <div className="space-y-3">
                <span className="text-[#a1a1aa] text-xs font-bold uppercase tracking-wide block">Tecnología de Combustible</span>
                    ...
                    <button
                      ...
                      className={`py-3 rounded-xl text-xs font-bold uppercase tracking-wider border transition-all cursor-pointer ${
                        fuelType === type
                          ...
                          : "bg-[#1a263e]/40 text-[#a1a1aa] border-[#1e2e4a] hover:bg-[#1a263e] hover:text-[#f1f5f9]"
                      }`}
                    >
                      {type}
                    </button>
            ...
            {/* Note block */}
            <div className="bg-[#1a263e]/40 border border-[#1e2e4a] p-4 rounded-xl text-[11px] text-[#a1a1aa] leading-relaxed mt-4">
              <p className="font-bold text-[#f1f5f9] mb-1 uppercase tracking-wider text-[9px] text-[#60a5fa]">Supuestos del Cálculo:</p>
              Cálculo estimado en base a un promedio de 26 días laborados al mes. Incluye una provisión mensual de S/. 150 para gastos operativos del vehículo.
            </div>
          </div>

          {/* Profit Dashboard - RIGHT */}
          <div className="lg:col-span-7 bg-[#131c2e] border border-[#1e2e4a] rounded-xl p-6 md:p-8 flex flex-col justify-between space-y-8 relative overflow-hidden">
            {/* Glowing Accent Ring */}
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-center pb-4 border-b border-[#1e2e4a]/60">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-sm font-bold uppercase tracking-wider text-[#f1f5f9]">Retorno Estimado Mensual</h3>
                </div>
                <span className="bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 px-2 py-0.5 rounded-xl text-[9px] font-bold uppercase tracking-widest">
                  Rentable
                </span>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {/* Monthly Gross */}
                <div className="bg-[#1a263e]/40 border border-[#1e2e4a] p-5 rounded-xl flex flex-col justify-between">
                  <div>
                    <span className="text-[9px] font-bold uppercase tracking-wider text-[#71717a] block">Ingreso Bruto</span>
                    <span className="text-xs text-[#a1a1aa] font-sans">Total Cobrado</span>
                  </div>
                  <div className="mt-4">
                    <span className="text-[#71717a] text-xs font-bold mr-0.5">S/.</span>
                    <span className="text-xl font-bold text-[#f1f5f9] font-mono">
                ...
                {/* Monthly Savings */}
                <div className="bg-[#1a263e]/40 border border-emerald-500/20 p-5 rounded-xl flex flex-col justify-between relative overflow-hidden">
                  {fuelType !== "Gasolina" && (
                  ...
                  <div>
                    ...
                    <span className="text-xs text-[#a1a1aa] font-sans">Frente a Gasolina</span>
                  </div>
                  <div className="mt-4">
                ...
                {/* Net Income */}
                <div className="bg-[#1a263e]/90 border border-[#3b82f6]/50 p-5 rounded-xl flex flex-col justify-between shadow-[0_0_15px_rgba(59,130,246,0.1)]">
                  <div>
                    <span className="text-[9px] font-bold uppercase tracking-wider text-[#f1f5f9] block">Ganancia Neta</span>
                    <span className="text-xs text-[#a1a1aa] font-sans">Bolsillo Libre</span>
                  </div>
                  <div className="mt-4">
              ...
              <div className="bg-[#060a13] border border-[#1e2e4a] rounded-xl p-5 space-y-4">
                <span className="text-[10px] font-bold uppercase tracking-wider text-[#71717a] block">Simulación de Pago de Crédito Directo</span>
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      ...
                      <p className="text-xs text-[#a1a1aa]">
                        Cuota de Crédito EPSA Estimada: <span className="text-[#f1f5f9] font-bold">S/. {estimatedCreditInstallment} / mes</span>
                      </p>
                    </div>
                    <p className="text-[11px] text-[#71717a] pl-4 font-sans leading-relaxed">
                      Calculada para un plazo estándar a tasas de interés preferencial para mototaxis.
                    </p>
                  </div>

                  <div className="bg-emerald-500/10 border border-emerald-500/20 p-3 rounded-xl text-center shrink-0 w-full sm:w-auto">
            ...
            <div className="border-t border-[#1e2e4a]/60 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex gap-3 items-center">
                ...
                <div>
                  <h4 className="text-xs font-bold text-[#f1f5f9] uppercase tracking-wider">¡Inversión Segura y Altamente Rentable!</h4>
                  <p className="text-[11px] text-[#a1a1aa] mt-0.5 leading-relaxed font-sans max-w-md">
              ...
              <a
                ...
                className="bg-[#60a5fa] hover:bg-[#1e3a8a] text-white font-bold uppercase tracking-wider text-[10px] py-3 px-5 rounded-xl flex items-center gap-1.5 shrink-0 transition-colors shadow-sm group"
              >
                Solicitar Crédito
